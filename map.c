...
//#define LOGIC_OPERATION_TEMPLATE(name,op)
...
#define LOWEST_PRIORITY_OPERATOR 2 
...
const char *get_parentheses_end(const char *left_parenthesis_start) {
...
const char *get_next_operand_end_position(const char *start, const char *end) {
...
const char *lowest_priority_op(const char *start, const char *end, char *op) {
